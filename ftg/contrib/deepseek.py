"""DeepSeek backend for FtG.

Requires: pip install fathom-mode[openai]
DeepSeek uses the OpenAI-compatible API, so it shares the openai dependency.
"""
...
class DeepSeekBackend:
    """
    FtGBackend implementation for DeepSeek.
    ...
    def _client(self) -> Any:
        ...
        self._cached_client = openai.OpenAI(api_key=self.api_key, base_url=self.base_url)
        return self._cached_client
